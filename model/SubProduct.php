 ...
 * Time: 5:31 PM
 */
class SubProduct extends DB
{
    public $tableName = 'sub_products';
    ...
    public function getSubProductsWithProduct()
    {
        $sql = "select {$this->tableName}.*,products.name as product_name, {$this->tableName}.display_order as product_display_order from {$this->tableName} left join products on products.product_id = {$this->tableName}.product_id order by {$this->tableName}.sub_product_id asc";
        //echo $sql;exit();
